...
<br>
### Overview
I started out in finance as a hedge fund analyst trading long and (mostly) short equity—even getting a CFA and CPA along the way. At work, the way I approached markets became increasingly quantitative until it reached a point where I decided it was time to formally puruse a more quantitative role while still doing hedge fund consulting (e.g., empirical finance work, predictive modeling, web scraping).
