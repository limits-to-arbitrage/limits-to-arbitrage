...
<br>
### Overview
I started out in finance as a hedge fund analyst trading long and (mostly) short equity—even getting a CFA and CPA along the way. At work, the way I approached markets became increasingly quantitative, to the point where I decided it was time to formally puruse a more quantitative role (while doing hedge fund consulting).
...
Always interested in collaborating on systematic strategies, empirical finance work (I wrote a paper with a buddy of mine on SPACs recently), or any interesting data project!

Happy to hear about roles in quantitative research, data science, machine learning engineering, etc.
