# Overview
Hedge fund analyst and consultant, long and (mostly) short equity. Traded traditional IPOs, alternative IPOs (e.g., Reg A+, reverse mergers), SPACs, accounting frauds, distressed equities, bankruptcies, stock promotions, etc. Currently working on strategies/systems that use fundamentals-based signals while going back to school for more mathematics and computer science.
