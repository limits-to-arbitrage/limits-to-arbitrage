...
Currently trading (and developing more) systematic, equity market-neutral strategies which use fundamental signals. Also back to school for more mathematics and computer science coursework. I've professionally traded traditional IPOs, alternative IPOs (e.g., Reg A+, reverse mergers), SPACs, accounting frauds, distressed equities, bankruptcies, stock promotions, etc.
